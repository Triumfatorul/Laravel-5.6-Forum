...
class RankController extends Controller
{
     ...
     public function showBanUserForm($id)
    {
        ...
        if(Auth()->user()->user_rank == 'Admin 1' || Auth()->user()->user_rank == 'Admin 2' || Auth()->user()->user_rank == 'Admin 3' &&  $user->banned == 0) {
            ...
            if ($user->banned) {
                return redirect('../public/home')->with('error', 'This user is already banned');
            }

            return redirect('../public/home')->with('error', 'Unauthorized access!');
        }
    }
     ...
     public function banUser(Request $request ,$id)
    {
        ...
        if(Auth()->user()->user_rank == 'Admin 1' || Auth()->user()->user_rank == 'Admin 2' || Auth()->user()->user_rank == 'Admin 3'   &&  $user->banned == 0) {
            ...
            return redirect('../public/Rank/'.$user->id)->with('succes', 'You banned '.$user->name.' succesful for '.$time.' day(s)!');
        } else {
             if ($user->banned) {
                return redirect('../public/home')->with('error', 'This user is already banned');
            }
    ...
    public function store(Request $request)
    {
     ...
     return redirect('../public/home')->with('succes', 'The rank was created succesful');
    }
    ...
    public function update(Request $request, $id)
    {
     ...
     return redirect('../public/home')->with('succes', 'The rank of '.$user->name.' was updated succesful');
    }
