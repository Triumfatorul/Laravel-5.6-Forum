...
class FriendsController extends Controller
{
    ...
    public function store($id)
    {
        ...
        if(count($friend_check) > 0) {
           return redirect('../public/Friends')->with('succes', 'You already sent a friend request to that user!');
        } 
            $friend = new Friend;
            ...
            $friend->accepted = 0;
            $friend->save();
            return redirect('../public/Friends')->with('succes', 'Friend request sent!');
